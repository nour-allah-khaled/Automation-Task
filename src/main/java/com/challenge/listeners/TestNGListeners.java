...
import org.testng.*;
import java.io.File;
import static com.challenge.media.ScreenShotMedia.SCREENSHOT_PATH;
...
public class TestNGListeners implements IExecutionListener, IInvokedMethodListener, ITestListener {
    ...
    public void onTestSkipped(ITestResult result) {LogsManager.info("Test Case " + result.getName() + " skipped");}
}